...
import { StaticRecommendationBlock, StaticRecommendationBlockProps } from '.'
import { rootReducer } from '~domains/redux'

export default {
  component: StaticRecommendationBlock,
...
store.getState().server.staticRecommendation[
...
export const basic = (args: StaticRecommendationBlockProps): JSX.Element => (
  <Provider store={store}>
    <StaticRecommendationBlock {...args} />
  </Provider>
)
