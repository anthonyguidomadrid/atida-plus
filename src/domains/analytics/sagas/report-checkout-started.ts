...
import { triggerReportCheckoutStarted } from '..'
import {
...
export function* doReportCheckoutStartedSaga({}: PayloadAction): SagaIterator {
...
export function* reportCheckoutStartedSaga(): SagaIterator {
  yield all([
    takeLatest(triggerReportCheckoutStarted, doReportCheckoutStartedSaga)
  ])
}
